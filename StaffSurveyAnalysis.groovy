...
new File("/Users/SPC/Downloads/_survey/").listFiles().each { file ->
	...
	if ((excellent / 51) + (good / 51) >= 0.5) cat1 << question + " - (" + (((excellent / 51) + (good / 51)) * 100) + "%)"
	if ((excellent / 51) + (good / 51) + (fair / 51) >= 0.75) cat2 << question + " - (" + (((excellent / 51) + (good / 51) + (fair / 51)) * 100) + "%)"
